## AdamAddem
Computer Science student at the Universiry of Central Florida<br/>
C++, C, and C# developer<br/>
Currently creating a 2D Game Engine (AdamLibSDL3) to allow game developers to script entirely in C++
